...
const Footer = () => {
  return (
    <div className="mt-12 mb-0">
      <footer className="footer sm:footer-horizontal  bg-gradient-to-r from-[#632EE3] to-[#9F62F2]    p-10">
        <nav>
      ...
      <footer className="footer bg-base-200 text-base-content  bg-gradient-to-r from-[#632EE3] to-[#9F62F2] border-t px-10 py-4">
        ...
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            ...
            <a href="https://play.google.com/store/games?hl=en" target="_blank">
              <FaGooglePlay className="w-[24px] h-[24px]" />
            </a>
            <span>
              <span>
